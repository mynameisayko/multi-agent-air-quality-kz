...
DATA_PATH = PROJECT_ROOT / "data" / "external" / "airdata_almaty_hourly" / "pm25.csv.gz"
PROCESSED_DIR = PROJECT_ROOT / "data" / "processed"
MODEL_DIR = PROJECT_ROOT / "models" / "tft_almaty_hourly"
REPORT_DIR = PROJECT_ROOT / "reports" / "tft_almaty_hourly"
...
def build_hourly_dataframe() -> pd.DataFrame:
    ...
    # Restrict to the modern high-coverage period for a more stable city-level series.
...
def main() -> None:
    ...
    save_dataframe(df, PROCESSED_DIR / "almaty_hourly_pm25_city.csv")
