...
\caption{Comparison between TFT and simple baseline models. This figure is regenerated after importing Kaggle forecast outputs.}
...
Overall, the study is expected to show that an interpretable MAS--TFT framework can serve as a viable foundation for urban air quality early warning and health-oriented environmental analytics in Kazakhstan. Immediate future work includes completing baseline comparisons, importing full Kaggle forecast outputs into the manuscript figures, adding multi-city meteorological covariates, and performing interpretability analysis using TFT variable-importance and attention outputs.
