...
\caption{Actual PM$_{2.5}$ values and 24-hour-ahead forecasts from TFT, XGBoost, and persistence for a representative station-level forecast window.}
...
\caption{Confusion matrices for observed health-risk classes versus TFT and XGBoost predicted risk classes on the shared comparison subset.}
...
\caption{MAE and RMSE comparison between TFT, XGBoost, and simple baseline models on the shared comparison subset.}
