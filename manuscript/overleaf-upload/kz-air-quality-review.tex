...
\begin{table}[h]
\caption{Preliminary model comparison on the shared XGBoost--TFT test overlap. Lower MAE, RMSE, and MAPE indicate better performance.}\label{tab:baseline_comparison}
\begin{tabular}{@{}llll@{}}
\toprule
Model & MAE & RMSE & MAPE\\
\midrule
